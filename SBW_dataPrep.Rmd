...
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'SBW_dataPrep', path = '..')$version`"
...
```{r setup-SBW-dataPrep, include=FALSE}
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "SBW_dataPrep", path = '..')$authors), sep = ', ')`
...
```{r moduleInputs-SBW-dataPrep, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_inputs <- SpaDES.core::moduleInputs("SBW_dataPrep", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_inputs,
             caption = "List of (ref:SBW-dataPrep) input objects and their description.") |>
...
```{r moduleParams-SBW-dataPrep, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("SBW_dataPrep", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_params, caption = "List of (ref:SBW-dataPrep) parameters and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
...
```{r moduleOutputs-SBW-dataPrep, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_outputs <- SpaDES.core::moduleOutputs("SBW_dataPrep", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_outputs, caption = "List of (ref:SBW-dataPrep) outputs and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
